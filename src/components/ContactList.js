...
import "../App.css"
import { collection,query,getFirestore,onSnapshot, limit,where } from "firebase/firestore";
...
const ContactList = (props) =>{
    const {user,receiver,setReceiver,scroller,setContactLoading,search} = props
